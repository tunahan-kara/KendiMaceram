...
* **Kapsamlı Firebase Entegrasyonu:**
    * **Authentication:** Google hesabı ile hızlı giriş ve "Hesabı Sil" gibi kullanıcı haklarını koruyan sistemler.
...
# 📖 Kendi Maceram (My Own Adventure)
...
* **Full Firebase Integration:**
    * **Authentication:** Rapid Google Sign-In and user rights management, including account deletion.
...
* **Personalized User Experience:**
    * **Library:** Save favorite or ongoing stories to a personal collection.
